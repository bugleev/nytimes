...
class Body extends Component {
  render() {
    return (
      <div className="main">
        <Navbar />
        <div className="header uk-width-2-3 uk-text-center"><h1> THE LOGO </h1></div>
        <div className="uk-width-3-4@m uk-flex-center results uk-container" >
          <Form />
          <div className="uk-child-width-1-1 uk-child-width-1-3@s uk-flex-around" data-uk-grid>
            ...
            <div className="uk-animation-toggle">
              <div className="uk-card uk-card-primary uk-card-body uk-animation-slide-bottom-small">
                <p className="uk-text-center">Fade</p>
              </div>
            </div>
            <div className="uk-animation-toggle">
              <div className="uk-card uk-card-secondary uk-card-body uk-animation-slide-bottom-small">
                <p className="uk-text-center">Fade</p>
              </div>
            </div>
